 ...
 <div class="container">
  ...
  @if($status=='ok_create')
   <div class="alert alert-success">
    ...
    <strong>Concepto registrado con éxito</strong>
   </div>
  @endif
  ...
  @if($status=='ok_delete')
   <div class="alert alert-danger">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
    <strong>Concepto eliminado con éxito</strong>
   </div>
  @endif
  ...
  @if($status=='ok_update')
   <div class="alert alert-warning">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
    <strong>Concepto actualizado con éxito</strong>
   </div>
  @endif
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Editar</strong> concepto</h2>
                                    </div>
                                    <!-- END Form Elements Title -->
                                    
                                    <!-- Basic Form Elements Content -->
                                     {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/factura/updateconcepto',$conceptos->id))) }}
